...
def transformer(U, theta, name='SpatialTransformer', **kwargs):
    ...
    def _transform3(theta, input_dim):
        ...
        H_array = Upsample(size=(int(height_float), int(width_float)), mode='nearest')(Hs)
        H_array = H_array.permute(0, 2, 3, 1)
        # print("H_array:",H_array.shape)
        H_array = H_array.contiguous().view(-1, 3, 3)
        ##########################################
        ...
        # print("x_s_flat:", x_s_flat.shape)
        # print("y_s_flat:", y_s_flat.shape)
    ...
    # print(max(warp_image), min(warp_image))
